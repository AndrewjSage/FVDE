...
stargazer(RelTransport %>% select(CAR), type = 'text', summary.stat = c("n", "mean", "sd", "min", "median", "max"), notes.append = FALSE, header = FALSE)
```
...
stargazer(RelTransport %>% select(PUB), type = 'text', summary.stat = c("n", "mean", "sd", "min", "median", "max"), notes.append = FALSE, header = FALSE)
```
### National Rates:
...
stargazer(RelTransport %>% select(NVC), type = 'text', summary.stat = c("n", "mean", "sd", "min", "median", "max"), notes.append = FALSE, header = FALSE)
```
...
stargazer(RelTransport %>% select(TRV), type = 'text', summary.stat = c("n", "mean", "sd", "min", "median", "max"), notes.append = FALSE, header = FALSE)
```
...
stargazer(RelTransport %>% select(EKW), type = 'text', summary.stat = c("n", "mean", "sd", "min", "median", "max"), notes.append = FALSE, header = FALSE)
```
