...
Unsurprisingly, there is a high correlation between the any higher education rate and the college graduation rate (0.84). There also appears to be a high correlation between the high school graduation rate and any higher education rate (0.71).
...
Again, we see a high correlation between the any higher education rate and college graduation rate (0.91). There is also high correlation between the 9th grade graduation rate and high school graduation rate (0.77), high school graduation rate and any higher education rate (0.76), and public school suspensions and public school enrollment (0.78).
...
We can see there is skewedness in some of the variables, like the 9th grade graduation rate, preschool enrollment rate, public school suspensions and public school enrollment. There also appears to be outliers in the high school graduation rate and preschool enrollment.

### Summary statistics

```{r, results='asis'}
stargazer(ballsSumm, title="Summary Stats", type = 'latex', summary.stat = c("n","mean","sd", "min", "median", "max", "p25", "p75"), notes.append=F, header=F)
```

## Normalization and Z-Score Calculations

Because we want larger numbers to correspond to better living, some variable may need to be flipped.
