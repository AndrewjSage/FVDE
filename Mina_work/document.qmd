...
I guess we are calling these milestone projects? Well in any case I'll be doing what Binh did but for the lifelong learning ballsset. 
...
ballsCorr <- balls |> select(-FVDEWVAR_2023.2024, -FVDEYLCV_2024.2025) |> na.omit()
ballsCorr1 <- balls |> na.omit()
...
```{r}
# Use R's built in PCA function to perform PCA on the ballsset
pca_result <- prcomp(ballsCorr, scale. = TRUE)
